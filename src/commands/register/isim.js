...
module.exports.run = async (client, message, args, embed) => {
    ...
    if (!member || !isim || !yas) message.reply({ content: `Hatalı kullanım, doğrusu; \`${settings.bot.prefix}isim [@Rencia/ID] <isim> <yaş>\`` }).delete(10);
...
exports.config = {
    category: "register",
    name: "isim",
    usage: `${settings.bot.prefix}isim [@Rencia/ID] <isim> <yaş>`,
    guildOnly: true,
    aliases: ["isim"],
};
